...
def main():
    if args.finetune or (args.pretrained and 'finetuneTrue' in args.pretrained):
        ...
        save_path = args.root_dir + f'small/checkpoints_{args.scenario}_range{args.range}km/pretrained_seed{pretrained_seed}_seed_{args.seed}_trainvalnum_{args.train_val_num}_testnum_{args.test_num}_epoch_{args.epochs}_finetune{args.finetune}_finetunescenario{args.finetune_scenario}_alpha_{args.alpha}_scheduler{args.scheduler}/'
    else:
        save_path = args.root_dir + f'small/checkpoints_{args.scenario}_range{args.range}km/seed_{args.seed}_trainvalnum_{args.train_val_num}_testnum_{args.test_num}_epoch_{args.epochs}_finetune{args.finetune}_alpha_{args.alpha}_scheduler{args.scheduler}/'
    ...
    if args.bty != 'flat':
        save_path = args.root_dir + f'small/checkpoints_{args.scenario}_{args.bty}_range{args.range}km/seed_{args.seed}_trainvalnum_{args.train_val_num}_testnum_{args.test_num}_epoch_{args.epochs}_finetune{args.finetune}_alpha_{args.alpha}_scheduler{args.scheduler}/'
